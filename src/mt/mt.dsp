...
# ADD LIB32 /nologo /out:"..\..\lib\Release\mt.lib"
...
# ADD CPP /nologo /MDd /W2 /Gm /GX /ZI /Od /I "..\..\include" /I "." /I "..\..\vds\\" /I "..\mt" /I "..\vdslib" /I ".\\" /I "..\include" /I "..\xbs" /D "_LIB" /D "GLOD" /D "WIN32" /D "_DEBUG" /D "_MBCS" /YX /FD /GZ /c /Tp
...
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo
# ADD LIB32 /nologo /out:"..\..\lib\Debug\mt.lib"
