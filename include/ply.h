...
extern PlyFile *ply_open_for_writing(char *filename,
                                     int nelems,
                                     char **elem_names,
                                     int file_type,
                                     float *version);
extern PlyFile *ply_write(FILE *fp,
                          int nelems,
                          char **elem_names,
                          int file_type);
...
extern void ply_describe_element(PlyFile *plyfile,
                                 char *elem_name,
                                 int nelems,
                                 int nprops,
                                 PlyProperty *prop_list);
extern void ply_element_count(PlyFile *plyfile,
                              char *elem_name,
                              int nelems);
extern void ply_describe_property(PlyFile *plyfile,
                                  char *elem_name,
                                  PlyProperty *prop);
extern void ply_describe_other_properties(PlyFile *plyfile,
                                          PlyOtherProp *other,
                                          int offset);
extern void ply_describe_other_elements(PlyFile *plyfile,
                                        PlyOtherElems *other_elems);
extern void ply_put_comment(PlyFile *plyfile, char *comment);
extern void ply_put_obj_info(PlyFile *plyfile, char *obj_info);
extern void ply_header_complete(PlyFile *plyfile);



extern void ply_put_element_setup(PlyFile *plyfile, char *elem_name);
extern void ply_put_element(PlyFile *plyfile, void *elem_ptr);
extern void ply_put_other_elements (PlyFile *plyfile);



extern PlyFile *ply_open_for_reading(char *filename,
                                     int *num_elem_types,
                                     char ***elem_names,
                                     int *file_type,
                                     float *version);
extern PlyFile *ply_read(FILE *fp, int *nelems, char ***elem_names);
extern void ply_get_info(PlyFile *ply, float *version, int *file_type);

extern char **ply_get_comments(PlyFile *plyfile, int *num_comments);
extern char **ply_get_obj_info(PlyFile *plyfile, int *num_obj_info);

extern PlyProperty **ply_get_element_description(PlyFile *plyfile,
                                                 char *elem_name,
                                                 int *nelems,
                                                 int *nprops);
extern void ply_get_element_setup(PlyFile *plyfile,
                                  char *elem_name,
                                  int nprops,
                                  PlyProperty *prop_list);
extern void ply_get_property(PlyFile *plyfile,
                             char *elem_name,
                             PlyProperty *prop);
extern PlyOtherProp *ply_get_other_properties(PlyFile *plyfile,
                                              char *elem_name,
                                              int offset);
extern void ply_get_element(PlyFile *plyfile, void *elem_ptr);
extern PlyOtherElems *ply_get_other_element (PlyFile *plyfile,
                                             char *elem_name,
                                             int elem_count);
...
#if 0 // An example program for PLY novices
/*
